...
@section('content')
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-8">
                    <h1 class="m-0">Approved Request Order by HR</h1>
                </div><!-- /.col -->
                <div align=right class="col-sm-4">
                    @can('create po')
                        <a href="{{ route('HRApproved.index') }}" class="btn btn-secondary">
            ...
            <div class="row">
                ...
                <div class="card">
                       <div class="card-body text-capitalize">
                         <form action="{{ route('GAApproved.updatest') }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            <div class="row justify-content-center">
                                <div class="col-xs-10 col-sm-10 col-md-10">
                                    <div class="form-group">
                                        <label for="line"><strong>Department</strong></label>
                                        <select onchange="callAjax()" disabled class="form-control" required id="line"
                                            name="line">
                            ...
                            <div class="row">
                                ...
                                <div class="modal-dialog modal-lg" customer="document">
                                    <div class="modal-content">
                                        <form method="POST" action="{{ route('GAApproved.reject') }}">
                                            @csrf
                    ...
                    if (response.length > 0) {
                        ...
                        $.each(response, function(i, item) {
                            ...
                            form += '<td><input ' + status + ' type="text" name="jml[]" value="' +
                                ...
                                .rem + '"></td>';
                                // form += '<td><input  type="text" name="po[]" value="' +
                                // item.po + '"></td>'; 
                                form += '<td><input  type="text" name="po[]" value="' + (item.po !== null ? item.po : '') + '"></td>'; 
                            form += '<td></td></tr>';
                            $('#konten').append(form);
    ...
    //         // Anda dapat menambahkan kode di sini jika perlu
    //     }
    // });

...
@section('content')
    ...
    <div class="content">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="alert alert-info">
                        Request Order Approved by GA {{-- sebagai penyedia barang --}}
                    </div>
                </div>
            </div>
        ...
        <div class="row mb-3">
            <div class="col-lg-12">
                <form action="{{ route('GAApproved.filter') }}" method="GET">
                                            ...
                                            <td>
                                                @php
                                                    $statusText = [
                                                        0 => 'Permohonan Baru',
                                                        1 => 'Disetujui Atasan',
                                                        2 => 'Disetujui Dept. ' . $ex->dept_name,
                                                        3 => 'Disediakan Dept. ' . $ex->dept_name,
                                                        4 => 'Rejected by Direct Superior' . $ex->dept_name,
                                                        5 => 'Rejected by Providing Department' . $ex->dept_name,
                                                        6 => 'Rejected by Providing Department' . $ex->dept_name,
                                            ...
                                            <td>
                                                ...
                                                <div class="btn-group" role="group" aria-label="Basic example">
                                                    <a class="btn btn-info far fa-edit"
                                                        href="GAApproved/{{ $ex->doc_ro }}/show " title="Approved"></a>
                                                </div>
                                            </td>
                                        </tr>
                                    @endforeach

                                    ...
                                    <div class="col-xs-12 col-sm-12 col-md-12">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="form-floating">
                                                <input type="text" name="ceo" placeholder="Ceo name" value="{{$c->ceo}}"> / 
                                                <input type="phone" placeholder="Ceo name" value="{{$c->c_phone}}"> / 
                                                <input type="email" placeholder="Ceo name" value="{{$c->c_email}}"> / 
                                                <input type="date"  placeholder="hh/bb/tttt" value="{{$c->bday}}">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="form-floating">
                                                <input type="text" name="" placeholder="Purchasing name" value="{{$c->purc}}"> / 
                                                <input type="phone" placeholder="Purchasing phone" value="{{$c->p_phone}}"> / 
                                                <input type="email" placeholder="Purchasing email" value="{{$c->p_email}}"> 
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="form-floating">
                                                <input type="text" placeholder="finance name" value="{{$c->fin}}"> / 
                                                <input type="phone" placeholder="finance phone" value="{{$c->f_phone}}"> / 
                                                <input type="email"placeholder="finance email" value="{{$c->f_email}}"> 
                                            </div>
                                        </div>

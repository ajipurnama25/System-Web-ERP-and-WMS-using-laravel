...
<div class="content-header">
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-8">
                <h1 class="m-0">Approved Request Order by Providing Department</h1>
            </div><!-- /.col -->
            ...
            <div class="row">
                ...
                <div class="card">
                       <div class="card-body text-capitalize">
                         <form action="{{ route('HRApproved.updatest') }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            ...
                            <table id="table" class="table list" !style="display:none" align="right">
                                <thead>
                                    <tr>
                                        ...
                                        <th style="text-align: center">Jumlah ACC</th>
                            ...
                            <div class="row">
                                ...
                                <div class="modal-dialog modal-lg" customer="document">
                                    <div class="modal-content">
                                        <form method="POST" action="{{ route('HRApproved.reject') }}">
                                            @csrf
                    ...
                    if (response.length > 0) {
                        ...
                        $.each(response, function(i, item) {
                            ...
                            form += '<td><input ' + status + ' type="text" name="jml[]" value="' +
                                item.qty + '"></td>';
                            form += '<td><input  type="text" name="acc[]" value="' +
                                item.qty + '" ></td>'; 

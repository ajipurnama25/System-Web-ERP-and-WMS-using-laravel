...
@section('content')
    ...
    <div class="content-header">
        ...
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0">{{ __('Customer_extends') }}</h1>
                </div><!-- /.col -->
            </div><!-- /.row -->
        </div><!-- /.container-fluid -->
    </div>
    ...
    <div class="content">
        ...
        <option  value="" >  <a href="supplier/create" class="btn btn-success"></a>Induk anak </option>
            ...
            <div class="row">
                <div class="col-lg-6">
                    <a href="customer_ex/create" class="btn btn-success"><i class="fa fa-plus-circle nav-icon"></i>
                        Customer Extends</a>
                </div>
                <div class="col-lg-6">
                    &nbsp;
